...
export default class Contact extends React.Component {
    ...
    render() {
        ...
        return ( <
            ...
            h2 >
            Reach out
            for a project or just to say hello!My personal email is { ' ' } <
            a href = "mailto:shaun.wahle@gmail.com" > shaun.wahle @gmail.com < /a> < /
            h2 > <
            /div> <
            ...
            <
            button className = { this.state.submitted && 'submitted success' }
            onClick = { this.handleSubmit } > { this.state.buttonState } <
            /button> {
            isAnError &&
            <
